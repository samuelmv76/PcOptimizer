...
{
    private static readonly SolidColorBrush Info = Freeze("#8A8F98");
    private static readonly SolidColorBrush Suggestion = Freeze("#2F6FEB");
    private static readonly SolidColorBrush Warning = Freeze("#C7761B");
